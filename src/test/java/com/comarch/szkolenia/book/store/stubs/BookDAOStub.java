package com.comarch.szkolenia.book.store.stubs;
...
public class BookDAOStub implements BookDAO {
    @Override
    ...
    @Override
    public List<Book> findByTitleContainingIgnoreCaseOrAuthorContainingIgnoreCase(String searchTerm) {
        return List.of();
    }
